...
var NTI11020571 = {size: 0,kind: 24,base: null,node: null,finalizer: null};
...
function aux_write_stack_trace_1325038(f_1325040) {
  ...
  var result_1325041 = [null];
    ...
    L6: do {
      var j_1340236 = 0;
      var colontmp__11020463 = 0;
      colontmp__11020463 = (i_1325051 - 1);
      var res_11020468 = colontmp__11020463;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_11020468)) break L8;
            j_1340236 = res_11020468;
...
function is_whitespace_10995101(text_10995103) {
         return !/[^\s]/.test(text_10995103);
  

  
}
function is_whitespace_10995118(x_10995120) {
    var Tmp1;
    var Tmp2;

  var result_10995121 = false;

  var F={procname:"dochack.isWhitespace",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 134;
    if (!(x_10995120.nodeName == "#text")) Tmp2 = false; else {      Tmp2 = is_whitespace_10995101(x_10995120.textContent);    }    if (Tmp2) Tmp1 = true; else {      Tmp1 = (x_10995120.nodeName == "#comment");    }    result_10995121 = Tmp1;
  framePtr = F.prev;

  return result_10995121;
...
function to_toc_10995135(x_10995137, father_10995138) {
                var Tmp5;
            var Tmp6;
            var Tmp7;
            var Tmp8;
  ...
  framePtr = F;
    if ((x_10995137.nodeName == "UL")) {
    F.line = 139;
    var f_10995159 = {heading: null, kids: [], sortId: (father_10995138.kids != null ? father_10995138.kids.length : 0), doSort: false};
    F.line = 140;
    var i_10995161 = 0;
    L1: do {
      F.line = 141;
        L2: while (true) {
        if (!(i_10995161 < x_10995137.childNodes.length)) break L2;
          F.line = 142;
          var nxt_10995162 = addInt(i_10995161, 1);
          L3: do {
            F.line = 143;
              L4: while (true) {
                if (!(nxt_10995162 < x_10995137.childNodes.length)) Tmp5 = false; else {                  Tmp5 = is_whitespace_10995118(x_10995137.childNodes[nxt_10995162]);                }              if (!Tmp5) break L4;
                F.line = 144;
                nxt_10995162 = addInt(nxt_10995162, 1);
              }
          } while(false);
            if (!(nxt_10995162 < x_10995137.childNodes.length)) Tmp8 = false; else {              Tmp8 = (x_10995137.childNodes[i_10995161].nodeName == "LI");            }            if (!Tmp8) Tmp7 = false; else {              Tmp7 = (x_10995137.childNodes[i_10995161].childNodes.length == 1);            }            if (!Tmp7) Tmp6 = false; else {              Tmp6 = (x_10995137.childNodes[nxt_10995162].nodeName == "UL");            }          if (Tmp6) {
          F.line = 147;
          var e_10995189 = {heading: x_10995137.childNodes[i_10995161].childNodes[0], kids: [], sortId: (f_10995159.kids != null ? f_10995159.kids.length : 0), doSort: false};
          F.line = 148;
          var it_10995190 = x_10995137.childNodes[nxt_10995162];
          L9: do {
            F.line = 149;
            var j_10995198 = 0;
            F.line = 104;
            var colontmp__11020442 = 0;
            F.line = 149;
            colontmp__11020442 = it_10995190.childNodes.length;
            F.line = 106;
            var i_11020443 = 0;
            L10: do {
              F.line = 107;
                L11: while (true) {
                if (!(i_11020443 < colontmp__11020442)) break L11;
                  F.line = 149;
                  j_10995198 = i_11020443;
                  F.line = 150;
                  to_toc_10995135(it_10995190.childNodes[j_10995198], e_10995189);
                  F.line = 109;
                  i_11020443 = addInt(i_11020443, 1);
                }
            } while(false);
          } while(false);
          F.line = 151;
          if (f_10995159.kids != null) { f_10995159.kids.push(e_10995189); } else { f_10995159.kids = [e_10995189]; };
          F.line = 152;
          i_10995161 = addInt(nxt_10995162, 1);
          }
          else {
            F.line = 154;
            to_toc_10995135(x_10995137.childNodes[i_10995161], f_10995159);
            F.line = 155;
            i_10995161 = addInt(i_10995161, 1);
          }
          
        }
    } while(false);
    F.line = 156;
    if (father_10995138.kids != null) { father_10995138.kids.push(f_10995159); } else { father_10995138.kids = [f_10995159]; };
    }
    else {
    if (is_whitespace_10995118(x_10995137)) {
    }
    else {
    if ((x_10995137.nodeName == "LI")) {
    F.line = 160;
    var idx_10995235 = [];
    L12: do {
      F.line = 161;
      var i_10995243 = 0;
      F.line = 104;
      var colontmp__11020446 = 0;
      F.line = 161;
      colontmp__11020446 = x_10995137.childNodes.length;
      F.line = 106;
      var i_11020447 = 0;
      L13: do {
        F.line = 107;
          L14: while (true) {
          if (!(i_11020447 < colontmp__11020446)) break L14;
            F.line = 161;
            i_10995243 = i_11020447;
            if (!(is_whitespace_10995118(x_10995137.childNodes[i_10995243]))) {
            F.line = 162;
            if (idx_10995235 != null) { idx_10995235.push(i_10995243); } else { idx_10995235 = [i_10995243]; };
            }
            
            F.line = 109;
            i_11020447 = addInt(i_11020447, 1);
          }
      } while(false);
    } while(false);
      if (!((idx_10995235 != null ? idx_10995235.length : 0) == 2)) Tmp15 = false; else {        Tmp15 = (x_10995137.childNodes[idx_10995235[chckIndx(1, 0, (idx_10995235 != null ? idx_10995235.length : 0)+0-1)-0]].nodeName == "UL");      }    if (Tmp15) {
    F.line = 164;
    var e_10995276 = {heading: x_10995137.childNodes[idx_10995235[chckIndx(0, 0, (idx_10995235 != null ? idx_10995235.length : 0)+0-1)-0]], kids: [], sortId: (father_10995138.kids != null ? father_10995138.kids.length : 0), doSort: false};
    F.line = 166;
    var it_10995277 = x_10995137.childNodes[idx_10995235[chckIndx(1, 0, (idx_10995235 != null ? idx_10995235.length : 0)+0-1)-0]];
    L16: do {
      F.line = 167;
      var j_10995285 = 0;
      F.line = 104;
      var colontmp__11020451 = 0;
      F.line = 167;
      colontmp__11020451 = it_10995277.childNodes.length;
      F.line = 106;
      var i_11020452 = 0;
      L17: do {
        F.line = 107;
          L18: while (true) {
          if (!(i_11020452 < colontmp__11020451)) break L18;
            F.line = 167;
            j_10995285 = i_11020452;
            F.line = 168;
            to_toc_10995135(it_10995277.childNodes[j_10995285], e_10995276);
            F.line = 109;
            i_11020452 = addInt(i_11020452, 1);
          }
      } while(false);
    } while(false);
    F.line = 169;
    if (father_10995138.kids != null) { father_10995138.kids.push(e_10995276); } else { father_10995138.kids = [e_10995276]; };
    }
    else {
      L19: do {
        F.line = 171;
        var i_10995300 = 0;
        F.line = 104;
        var colontmp__11020455 = 0;
        F.line = 171;
        colontmp__11020455 = x_10995137.childNodes.length;
        F.line = 106;
        var i_11020456 = 0;
        L20: do {
          F.line = 107;
            L21: while (true) {
            if (!(i_11020456 < colontmp__11020455)) break L21;
              F.line = 171;
              i_10995300 = i_11020456;
              F.line = 172;
              to_toc_10995135(x_10995137.childNodes[i_10995300], father_10995138);
              F.line = 109;
              i_11020456 = addInt(i_11020456, 1);
            }
        } while(false);
      } while(false);
    }
      ...
      F.line = 174;
    if (father_10995138.kids != null) { father_10995138.kids.push({heading: x_10995137, kids: [], sortId: (father_10995138.kids != null ? father_10995138.kids.length : 0), doSort: false}); } else { father_10995138.kids = [{heading: x_10995137, kids: [], sortId: (father_10995138.kids != null ? father_10995138.kids.length : 0), doSort: false}]; };
    }
    }}
  framePtr = F.prev;
...
function extract_items_10950074(x_10950076, heading_10950077, items_10950080, items_10950080_Idx) {
      var Tmp1;
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      if (!!((x_10950076.heading == null))) Tmp1 = false; else {        Tmp1 = (x_10950076.heading.textContent == heading_10950077);      }    if (Tmp1) {
    L2: do {
      F.line = 83;
      var i_10955021 = 0;
      F.line = 104;
      var colontmp__11020485 = 0;
      F.line = 83;
      colontmp__11020485 = (x_10950076.kids != null ? x_10950076.kids.length : 0);
      F.line = 106;
      var i_11020486 = 0;
      L3: do {
        F.line = 107;
          L4: while (true) {
          if (!(i_11020486 < colontmp__11020485)) break L4;
            F.line = 83;
            i_10955021 = i_11020486;
            F.line = 84;
            if (items_10950080[items_10950080_Idx] != null) { items_10950080[items_10950080_Idx].push(x_10950076.kids[chckIndx(i_10955021, 0, (x_10950076.kids != null ? x_10950076.kids.length : 0)+0-1)-0].heading); } else { items_10950080[items_10950080_Idx] = [x_10950076.kids[chckIndx(i_10955021, 0, (x_10950076.kids != null ? x_10950076.kids.length : 0)+0-1)-0].heading]; };
            F.line = 109;
            i_11020486 = addInt(i_11020486, 1);
          }
      } while(false);
    } while(false);
    }
      ...
      L5: do {
        ...
        var i_10955041 = 0;
        F.line = 104;
        var colontmp__11020489 = 0;
        F.line = 86;
        colontmp__11020489 = (x_10950076.kids != null ? x_10950076.kids.length : 0);
        F.line = 106;
        var i_11020490 = 0;
        L6: do {
          F.line = 107;
            L7: while (true) {
            if (!(i_11020490 < colontmp__11020489)) break L7;
              F.line = 86;
              i_10955041 = i_11020490;
              F.line = 87;
              var it_10955042 = x_10950076.kids[chckIndx(i_10955041, 0, (x_10950076.kids != null ? x_10950076.kids.length : 0)+0-1)-0];
              F.line = 88;
              extract_items_10950074(it_10955042, heading_10950077, items_10950080, items_10950080_Idx);
              F.line = 109;
              i_11020490 = addInt(i_11020490, 1);
            }
        } while(false);
      } while(false);
    }
...
function tree_10941020(tag_10941022, kids_10941024) {
  var result_10941025 = null;

  var F={procname:"dochack.tree",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 11;
    result_10941025 = document.createElement(toJSStr(tag_10941022));
    L1: do {
      F.line = 12;
      var k_10941056 = null;
      F.line = 3;
      ...
      L2: do {
        F.line = 4;
          L3: while (true) {
          if (!(i_11020506 < (kids_10941024 != null ? kids_10941024.length : 0))) break L3;
            F.line = 12;
            k_10941056 = kids_10941024[chckIndx(i_11020506, 0, (kids_10941024 != null ? kids_10941024.length : 0)+0-1)-0];
            F.line = 13;
            result_10941025.appendChild(k_10941056);
            F.line = 6;
            i_11020506 = addInt(i_11020506, 1);
          }
      } while(false);
    } while(false);
  framePtr = F.prev;

  return result_10941025;

}
function text_10941152(s_10941154) {
  var result_10941155 = null;

  var F={procname:"dochack.text",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 27;
    result_10941155 = document.createTextNode(s_10941154);
  framePtr = F.prev;

  return result_10941155;
...
function uncovered_11000022(x_11000024) {
      var Tmp1;
    var Tmp2;

  var result_11000025 = null;

  var F={procname:"dochack.uncovered",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
  BeforeRet: do {
      if (!((x_11000024.kids != null ? x_11000024.kids.length : 0) == 0)) Tmp1 = false; else {        Tmp1 = !((x_11000024.heading == null));      }    if (Tmp1) {
    F.line = 194;
    if (!(x_11000024.heading.hasOwnProperty('__karaxMarker__'))) {
    Tmp2 = x_11000024;
    }
    else {
    Tmp2 = null;
    ...
    result_11000025 = Tmp2;
    break BeforeRet;
    }
    
    F.line = 195;
    result_11000025 = {heading: x_11000024.heading, kids: [], sortId: x_11000024.sortId, doSort: x_11000024.doSort};
    L3: do {
      F.line = 197;
      var i_11005036 = 0;
      F.line = 104;
      var colontmp__11020517 = 0;
      F.line = 197;
      colontmp__11020517 = (x_11000024.kids != null ? x_11000024.kids.length : 0);
      F.line = 106;
      var i_11020518 = 0;
      L4: do {
        F.line = 107;
          L5: while (true) {
          if (!(i_11020518 < colontmp__11020517)) break L5;
            F.line = 197;
            i_11005036 = i_11020518;
            F.line = 198;
            var y_11005037 = uncovered_11000022(x_11000024.kids[chckIndx(i_11005036, 0, (x_11000024.kids != null ? x_11000024.kids.length : 0)+0-1)-0]);
            if (!((y_11005037 == null))) {
            F.line = 199;
            if (result_11000025.kids != null) { result_11000025.kids.push(y_11005037); } else { result_11000025.kids = [y_11005037]; };
            }
            
            F.line = 109;
            i_11020518 = addInt(i_11020518, 1);
          }
      } while(false);
    } while(false);
    if (((result_11000025.kids != null ? result_11000025.kids.length : 0) == 0)) {
    F.line = 200;
    result_11000025 = null;
    }
    
  } while (false);
  framePtr = F.prev;

  return result_11000025;

}
function merge_tocs_11010034(orig_11010036, news_11010037) {
  var result_11010038 = null;

  var F={procname:"dochack.mergeTocs",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 203;
    result_11010038 = uncovered_11000022(orig_11010036);
    if ((result_11010038 == null)) {
    F.line = 205;
    result_11010038 = news_11010037;
    }
    else {
      L1: do {
        F.line = 207;
        var i_11010059 = 0;
        F.line = 104;
        var colontmp__11020512 = 0;
        F.line = 207;
        colontmp__11020512 = (news_11010037.kids != null ? news_11010037.kids.length : 0);
        F.line = 106;
        var i_11020513 = 0;
        L2: do {
          F.line = 107;
            L3: while (true) {
            if (!(i_11020513 < colontmp__11020512)) break L3;
              F.line = 207;
              i_11010059 = i_11020513;
              F.line = 208;
              if (result_11010038.kids != null) { result_11010038.kids.push(news_11010037.kids[chckIndx(i_11010059, 0, (news_11010037.kids != null ? news_11010037.kids.length : 0)+0-1)-0]); } else { result_11010038.kids = [news_11010037.kids[chckIndx(i_11010059, 0, (news_11010037.kids != null ? news_11010037.kids.length : 0)+0-1)-0]]; };
              F.line = 109;
              i_11020513 = addInt(i_11020513, 1);
            }
        } while(false);
      } while(false);
    }
  ...
  return result_11010038;

}
function build_toc_11010080(orig_11010082, types_11010084, procs_11010085) {
                      var Tmp7;

  var result_11010086 = null;

  var F={procname:"dochack.buildToc",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 211;
    var new_stuff_11010102 = {heading: null, kids: [], doSort: true, sortId: 0};
    L1: do {
      F.line = 212;
      var t_11020214 = null;
      F.line = 184;
      var i_11020501 = 0;
      F.line = 185;
      var l_11020502 = (types_11010084 != null ? types_11010084.length : 0);
      L2: do {
        F.line = 186;
          L3: while (true) {
          if (!(i_11020501 < l_11020502)) break L3;
            F.line = 212;
            t_11020214 = types_11010084[chckIndx(i_11020501, 0, (types_11010084 != null ? types_11010084.length : 0)+0-1)-0];
            F.line = 213;
            var c_11020230 = {heading: t_11020214.cloneNode(true), kids: [], doSort: true, sortId: 0};
            F.line = 214;
            t_11020214.__karaxMarker__ = true;
            L4: do {
              F.line = 215;
              var p_11020237 = null;
              F.line = 184;
              var i_11020498 = 0;
              F.line = 185;
              var l_11020499 = (procs_11010085 != null ? procs_11010085.length : 0);
              L5: do {
                F.line = 186;
                  L6: while (true) {
                  if (!(i_11020498 < l_11020499)) break L6;
                    F.line = 215;
                    p_11020237 = procs_11010085[chckIndx(i_11020498, 0, (procs_11010085 != null ? procs_11010085.length : 0)+0-1)-0];
                    if (!(p_11020237.hasOwnProperty('__karaxMarker__'))) {
                    F.line = 217;
                    var xx_11020238 = p_11020237.parentNode.getElementsByClassName("attachedType");
                      if (!((xx_11020238 != null ? xx_11020238.length : 0) == 1)) Tmp7 = false; else {                        Tmp7 = (xx_11020238[chckIndx(0, 0, (xx_11020238 != null ? xx_11020238.length : 0)+0-1)-0].textContent == t_11020214.textContent);                      }                    if (Tmp7) {
                    F.line = 220;
                    var q_11020246 = tree_10941020(makeNimstrLit("A"), [text_10941152(p_11020237.title)]);
                    F.line = 221;
                    q_11020246.setAttribute("href", p_11020237.getAttribute("href"));
                    F.line = 222;
                    if (c_11020230.kids != null) { c_11020230.kids.push({heading: q_11020246, kids: [], sortId: 0, doSort: false}); } else { c_11020230.kids = [{heading: q_11020246, kids: [], sortId: 0, doSort: false}]; };
                    F.line = 223;
                    p_11020237.__karaxMarker__ = true;
                    }
                    
                    }
                    
                    F.line = 188;
                    i_11020498 = addInt(i_11020498, 1);
                    if (!(((procs_11010085 != null ? procs_11010085.length : 0) == l_11020499))) {
                    F.line = 189;
            ...
            F.line = 224;
            if (new_stuff_11010102.kids != null) { new_stuff_11010102.kids.push(c_11020230); } else { new_stuff_11010102.kids = [c_11020230]; };
            F.line = 188;
            i_11020501 = addInt(i_11020501, 1);
            if (!(((types_11010084 != null ? types_11010084.length : 0) == l_11020502))) {
            F.line = 189;
            failed_assert_impl_1267680(makeNimstrLit("/home/runner/work/Nim/Nim/lib/system/iterators.nim(189, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    F.line = 225;
    result_11010086 = merge_tocs_11010034(orig_11010082, new_stuff_11010102);
  framePtr = F.prev;

  return result_11010086;

}
function add_10941100(parent_10941102, kid_10941103) {
      var Tmp1;
        var Tmp2;

  var F={procname:"dochack.add",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
      if (!(parent_10941102.nodeName == "TR")) Tmp1 = false; else {        if ((kid_10941103.nodeName == "TD")) Tmp2 = true; else {          Tmp2 = (kid_10941103.nodeName == "TH");        }        Tmp1 = Tmp2;      }    if (Tmp1) {
    F.line = 18;
    var k_10941104 = document.createElement("TD");
    F.line = 19;
    k_10941104.appendChild(kid_10941103);
    F.line = 20;
    parent_10941102.appendChild(k_10941104);
    }
    else {
      F.line = 22;
    parent_10941102.appendChild(kid_10941103);
    }
...
function set_class_10941118(e_10941120, value_10941121) {
  var F={procname:"dochack.setClass",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 25;
    e_10941120.setAttribute("class", toJSStr(value_10941121));
  framePtr = F.prev;

  
}
function to_html_10955071(x_10955073, is_root_10955074) {
      var Tmp1;
    function HEX3Aanonymous_10960015(a_10960017, b_10960018) {
          var Tmp1;

      var result_10960019 = 0;

      var F={procname:"toHtml.:anonymous",prev:framePtr,filename:"dochack.nim",line:0};
      framePtr = F;
      BeforeRet: do {
          if (!!((a_10960017.heading == null))) Tmp1 = false; else {            Tmp1 = !((b_10960018.heading == null));          }        if (Tmp1) {
        F.line = 106;
        var x_10970009 = a_10960017.heading.textContent;
        F.line = 107;
        var y_10970010 = b_10960018.heading.textContent;
        if ((x_10970009 < y_10970010)) {
        F.line = 108;
        result_10960019 = -1;
        break BeforeRet;
        }
        
        if ((y_10970010 < x_10970009)) {
        F.line = 109;
        result_10960019 = 1;
        break BeforeRet;
        }
        ...
        break BeforeRet;
          ...
          F.line = 113;
          result_10960019 = subInt(a_10960017.sortId, b_10960018.sortId);
          break BeforeRet;
        }
      ...
      return result_10960019;

    }

  var result_10955075 = null;
  ...
  BeforeRet: do {
    if ((x_10955073 == null)) {
    F.line = 91;
    result_10955075 = null;
    break BeforeRet;
    }
    
    if (((x_10955073.kids != null ? x_10955073.kids.length : 0) == 0)) {
    if ((x_10955073.heading == null)) {
    F.line = 93;
    result_10955075 = null;
    break BeforeRet;
    }
    ...
    F.line = 94;
    result_10955075 = x_10955073.heading.cloneNode(true);
    break BeforeRet;
    }
    
    F.line = 95;
    result_10955075 = tree_10941020(makeNimstrLit("DIV"), []);
      if (!!((x_10955073.heading == null))) Tmp1 = false; else {        Tmp1 = !(x_10955073.heading.hasOwnProperty('__karaxMarker__'));      }    if (Tmp1) {
    F.line = 97;
    add_10941100(result_10955075, x_10955073.heading.cloneNode(true));
    }
    
    F.line = 98;
    var ul_10960012 = tree_10941020(makeNimstrLit("UL"), []);
    if (is_root_10955074) {
    F.line = 100;
    set_class_10941118(ul_10960012, makeNimstrLit("simple simple-toc"));
    }
    else {
      F.line = 102;
    set_class_10941118(ul_10960012, makeNimstrLit("simple"));
    }
    
    if (x_10955073.doSort) {
    F.line = 104;
    x_10955073.kids.sort(HEX3Aanonymous_10960015);
    }
    ...
    L2: do {
      ...
      var i_11020524 = 0;
      F.line = 185;
      var l_11020525 = (x_10955073.kids != null ? x_10955073.kids.length : 0);
      L3: do {
        F.line = 186;
          L4: while (true) {
          if (!(i_11020524 < l_11020525)) break L4;
            F.line = 115;
            k_10985214 = x_10955073.kids[chckIndx(i_11020524, 0, (x_10955073.kids != null ? x_10955073.kids.length : 0)+0-1)-0];
            F.line = 116;
            var y_10985215 = to_html_10955071(k_10985214, false);
            if (!((y_10985215 == null))) {
            F.line = 118;
            add_10941100(ul_10960012, tree_10941020(makeNimstrLit("LI"), [y_10985215]));
            }
            
            F.line = 188;
            i_11020524 = addInt(i_11020524, 1);
            if (!(((x_10955073.kids != null ? x_10955073.kids.length : 0) == l_11020525))) {
            F.line = 189;
            failed_assert_impl_1267680(makeNimstrLit("/home/runner/work/Nim/Nim/lib/system/iterators.nim(189, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    if (!((ul_10960012.childNodes.length == 0))) {
    F.line = 119;
    add_10941100(result_10955075, ul_10960012);
    }
    
    if ((result_10955075.childNodes.length == 0)) {
    F.line = 120;
    result_10955075 = null;
    }
  ...
  return result_10955075;

}
function replace_by_id_10941172(id_10941174, new_tree_10941175) {
  var F={procname:"dochack.replaceById",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 32;
    var x_10941176 = document.getElementById(id_10941174);
    F.line = 33;
    x_10941176.parentNode.replaceChild(new_tree_10941175, x_10941176);
    F.line = 34;
    new_tree_10941175.id = id_10941174;
  framePtr = F.prev;

  
}
function togglevis_11020333(d_11020335) {
  var F={procname:"dochack.togglevis",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 230;
        if (d_11020335.style.display == 'none')
      d_11020335.style.display = 'inline';
    else
      d_11020335.style.display = 'none';
  
  framePtr = F.prev;

  
}
function groupBy(value_11020351) {
  var F={procname:"dochack.groupBy",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 238;
    var toc_11020352 = document.getElementById("toc-list");
    if ((alternative_11020319[0] == null)) {
    F.line = 240;
    var tt_11020373 = {heading: null, kids: [], sortId: 0, doSort: false};
    F.line = 241;
    to_toc_10995135(toc_11020352, tt_11020373);
    F.line = 242;
    tt_11020373 = tt_11020373.kids[chckIndx(0, 0, (tt_11020373.kids != null ? tt_11020373.kids.length : 0)+0-1)-0];
    F.line = 244;
    var types_11020390 = [[]];
    F.line = 245;
    var procs_11020407 = [[]];
    F.line = 247;
    extract_items_10950074(tt_11020373, "Types", types_11020390, 0);
    F.line = 248;
    extract_items_10950074(tt_11020373, "Procs", procs_11020407, 0);
    F.line = 249;
    extract_items_10950074(tt_11020373, "Converters", procs_11020407, 0);
    F.line = 250;
    extract_items_10950074(tt_11020373, "Methods", procs_11020407, 0);
    F.line = 251;
    extract_items_10950074(tt_11020373, "Templates", procs_11020407, 0);
    F.line = 252;
    extract_items_10950074(tt_11020373, "Macros", procs_11020407, 0);
    F.line = 253;
    extract_items_10950074(tt_11020373, "Iterators", procs_11020407, 0);
    F.line = 255;
    var ntoc_11020415 = build_toc_11010080(tt_11020373, types_11020390[0], procs_11020407[0]);
    F.line = 256;
    var x_11020416 = to_html_10955071(ntoc_11020415, true);
    F.line = 257;
    alternative_11020319[0] = tree_10941020(makeNimstrLit("DIV"), [x_11020416]);
    }
    
    if ((value_11020351 == "type")) {
    F.line = 259;
    replace_by_id_10941172("tocRoot", alternative_11020319[0]);
    }
    else {
      F.line = 261;
    replace_by_id_10941172("tocRoot", tree_10941020(makeNimstrLit("DIV"), []));
    }
    
    F.line = 262;
    togglevis_11020333(document.getElementById("toc-list"));
  framePtr = F.prev;

  
}
var db_11020528 = [null];
var contents_11020530 = [null];
var oldtoc_11030403 = [null];
var timer_11030404 = [null];
...
function fuzzy_match_10866054(pattern_10866056, str_10866057) {
  ...
  framePtr = F;
    ...
    F.line = 136;
    var colontmp__11040060 = nimMax(0, score_10866073);
    F.line = 137;
    var colontmp__11040061 = (0 < score_10866073);
    F.line = 135;
    nimCopy(result_10866061, {Field0: colontmp__11040060, Field1: colontmp__11040061}, NTI10866058);
  framePtr = F.prev;

  return result_10866061;

}
function text_10941135(s_10941137) {
  var result_10941138 = null;

  var F={procname:"dochack.text",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    F.line = 26;
    result_10941138 = document.createTextNode(toJSStr(s_10941137));
  framePtr = F.prev;

  return result_10941138;

}
function dosearch_11020547(value_11020549) {
    function HEX3Aanonymous_11030273(a_11030282, b_11030283) {
      var result_11030287 = 0;

      var F={procname:"dosearch.:anonymous",prev:framePtr,filename:"dochack.nim",line:0};
      framePtr = F;
        F.line = 305;
        result_11030287 = subInt(b_11030283["Field1"], a_11030282["Field1"]);
      framePtr = F.prev;

      return result_11030287;

    }

  var result_11020550 = null;

  var F={procname:"dochack.dosearch",prev:framePtr,filename:"dochack.nim",line:0};
  framePtr = F;
    if (((db_11020528[0] != null ? db_11020528[0].length : 0) == 0)) {
    F.line = 272;
    var stuff_11020556 = null;
    F.line = 273;
    ...
    stuff_11020556 = doc.documentElement;
    
    F.line = 286;
    db_11020528[0] = nimCopy(null, stuff_11020556.getElementsByClassName("reference"), NTI1796105);
    F.line = 287;
    contents_11020530[0] = nimCopy(null, [], NTI11020571);
    L1: do {
      F.line = 288;
      var ahref_11030214 = null;
      F.line = 184;
      var i_11040040 = 0;
      F.line = 185;
      var l_11040041 = (db_11020528[0] != null ? db_11020528[0].length : 0);
      L2: do {
        F.line = 186;
          L3: while (true) {
          if (!(i_11040040 < l_11040041)) break L3;
            F.line = 288;
            ahref_11030214 = db_11020528[0][chckIndx(i_11040040, 0, (db_11020528[0] != null ? db_11020528[0].length : 0)+0-1)-0];
            F.line = 289;
            if (contents_11020530[0] != null) { contents_11020530[0].push(ahref_11030214.getAttribute("data-doc-search-tag")); } else { contents_11020530[0] = [ahref_11030214.getAttribute("data-doc-search-tag")]; };
            F.line = 188;
            i_11040040 = addInt(i_11040040, 1);
            if (!(((db_11020528[0] != null ? db_11020528[0].length : 0) == l_11040041))) {
            F.line = 189;
            failed_assert_impl_1267680(makeNimstrLit("/home/runner/work/Nim/Nim/lib/system/iterators.nim(189, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    F.line = 290;
    var ul_11030225 = tree_10941020(makeNimstrLit("UL"), []);
    F.line = 291;
    result_11020550 = tree_10941020(makeNimstrLit("DIV"), []);
    F.line = 292;
    set_class_10941118(result_11020550, makeNimstrLit("search_results"));
    F.line = 293;
    var matches_11030246 = [];
    L4: do {
      F.line = 294;
      var i_11030259 = 0;
      F.line = 104;
      var colontmp__11040047 = 0;
      F.line = 294;
      colontmp__11040047 = (db_11020528[0] != null ? db_11020528[0].length : 0);
      F.line = 106;
      var i_11040048 = 0;
      L5: do {
        F.line = 107;
          L6: while (true) {
          if (!(i_11040048 < colontmp__11040047)) break L6;
            F.line = 294;
            i_11030259 = i_11040048;
            L7: do {
              F.line = 295;
              var c_11030260 = contents_11020530[0][chckIndx(i_11030259, 0, (contents_11020530[0] != null ? contents_11020530[0].length : 0)+0-1)-0];
              if (((c_11030260 == "Examples") || (c_11030260 == "PEG construction"))) {
              F.line = 300;
              break L7;
              }
              
              F.line = 301;
              var colontmp__11040055 = fuzzy_match_10866054(value_11020549, c_11030260);
              F.line = 301;
              var score_11030261 = colontmp__11040055["Field0"];
              F.line = 301;
              var matched_11030262 = colontmp__11040055["Field1"];
              if (matched_11030262) {
              F.line = 303;
              if (matches_11030246 != null) { matches_11030246.push({Field0: db_11020528[0][chckIndx(i_11030259, 0, (db_11020528[0] != null ? db_11020528[0].length : 0)+0-1)-0], Field1: score_11030261}); } else { matches_11030246 = [{Field0: db_11020528[0][chckIndx(i_11030259, 0, (db_11020528[0] != null ? db_11020528[0].length : 0)+0-1)-0], Field1: score_11030261}]; };
              }
              
            } while(false);
            F.line = 109;
            i_11040048 = addInt(i_11040048, 1);
          }
      } while(false);
    } while(false);
    F.line = 305;
    matches_11030246.sort(HEX3Aanonymous_11030273);
    L8: do {
      F.line = 306;
      var i_11030326 = 0;
      F.line = 104;
      var colontmp__11040052 = 0;
      F.line = 306;
      colontmp__11040052 = nimMin((matches_11030246 != null ? matches_11030246.length : 0), 19);
      F.line = 106;
      var i_11040053 = 0;
      L9: do {
        F.line = 107;
          L10: while (true) {
          if (!(i_11040053 < colontmp__11040052)) break L10;
            F.line = 306;
            i_11030326 = i_11040053;
            F.line = 307;
            matches_11030246[chckIndx(i_11030326, 0, (matches_11030246 != null ? matches_11030246.length : 0)+0-1)-0]["Field0"].innerHTML = matches_11030246[chckIndx(i_11030326, 0, (matches_11030246 != null ? matches_11030246.length : 0)+0-1)-0]["Field0"].getAttribute("data-doc-search-tag");
            F.line = 308;
            add_10941100(ul_11030225, tree_10941020(makeNimstrLit("LI"), [matches_11030246[chckIndx(i_11030326, 0, (matches_11030246 != null ? matches_11030246.length : 0)+0-1)-0]["Field0"]]));
            F.line = 109;
            i_11040053 = addInt(i_11040053, 1);
          }
      } while(false);
    } while(false);
    if ((ul_11030225.childNodes.length == 0)) {
    F.line = 310;
    add_10941100(result_11020550, tree_10941020(makeNimstrLit("B"), [text_10941135(makeNimstrLit("no search results"))]));
    }
    else {
      F.line = 312;
      add_10941100(result_11020550, tree_10941020(makeNimstrLit("B"), [text_10941135(makeNimstrLit("search results"))]));
      F.line = 313;
      add_10941100(result_11020550, ul_11030225);
    }
    
  framePtr = F.prev;

  return result_11020550;

}
function search() {
    function wrapper_11030435() {
      var F={procname:"search.wrapper",prev:framePtr,filename:"dochack.nim",line:0};
      framePtr = F;
        F.line = 320;
        var elem_11030437 = document.getElementById("searchInput");
        F.line = 321;
        var value_11030438 = elem_11030437.value;
        if (!(((value_11030438 != null ? value_11030438.length : 0) == 0))) {
        if ((oldtoc_11030403[0] == null)) {
        F.line = 324;
        oldtoc_11030403[0] = document.getElementById("tocRoot");
        }
        
        F.line = 325;
        var results_11035006 = dosearch_11020547(value_11030438);
        F.line = 326;
        replace_by_id_10941172("tocRoot", results_11035006);
        }
        else {
        if (!((oldtoc_11030403[0] == null))) {
        F.line = 328;
        replace_by_id_10941172("tocRoot", oldtoc_11030403[0]);
        }
        }
      framePtr = F.prev;
  ...
  framePtr = F;
    if (!((timer_11030404[0] == null))) {
    F.line = 330;
    clearTimeout(timer_11030404[0]);
    }
    
    F.line = 331;
    timer_11030404[0] = setTimeout(wrapper_11030435, 400);
  framePtr = F.prev;
